            ...
            <div class="wpallimport-collapsed-content-inner">
                ...
                <div class="input">
                    <div class="form-field wpallimport-radio-field wpallimport-realhomes_addonaddress_geocode_address_no_key">
                        ...
                        <label for="<?php echo $field_name; ?>_<?php echo $field_name; ?>_geocode_address_no_key" class="chooser_label">No API Key</label>
                    ...
                    <div class="form-field wpallimport-radio-field wpallimport-<?php echo $field_name; ?>_<?php echo $field_name; ?>_geocode_address_google_developers">
                        ...
                        <label for="<?php echo $field_name; ?>_<?php echo $field_name; ?>_geocode_address_google_developers" class="chooser_label">Google Developers API Key - <a href="https://developers.google.com/maps/documentation/geocoding/#api_key">Get free API key</a></label>
                        ...
                        <div class="switcher-target-<?php echo $field_name; ?>_<?php echo $field_name; ?>_geocode_address_google_developers" style="display: none;">
                    ...
                    <div class="form-field wpallimport-radio-field wpallimport-<?php echo $field_name; ?>_<?php echo $field_name; ?>_geocode_address_google_for_work">
                        ...
                        <label for="<?php echo $field_name; ?>_<?php echo $field_name; ?>_geocode_address_google_for_work" class="chooser_label">Google for Work Client ID &amp; Digital Signature - <a href="https://developers.google.com/maps/documentation/business">Sign up for Google for Work</a></label>
